...
let coreMembersDetails2023 = [
  ...
  },
  {
    ...
    avatar: "../assets/img/team/Abhijeet_Kulkarni.jpeg",
    badges: `       <span class="blue">APEX</span>
  ...
  id:6,
    name:"Tarun Addala",
    avatar: "../assets/img/team/Tarun_Addala.jpeg",
    badges: `       <span class="blue">APEX</span>
...
// *************** Ex-Core Members Details 2023 ***************************
let exMembersDetails2023 = [
  {
    id:0,
    name:"Parth Bhatnagar",
    avatar: "../assets/img/team/Parth_Bhatnagar.jpeg",
    badges: `       <span class="blue">APEX</span>
                    <span class="green">Founding President</span>
                `,
  ...
  },
  {
    ...
    badges: `       <span class="blue">APEX</span>
                    <span class="green">Marketing Head</span>
                `,
    socialLinkedinLink: "https://www.linkedin.com/in/jhanavi-agarwal-65922a260/",
  },
  {
  id:5,
    name:"Bonam Sai Shreya",
    avatar: "../assets/img/team/Sai_Shreya.jpeg",
    badges: `       <span class="blue">APEX</span>
                    <span class="green">Treasurer</span>
                `,
    socialLinkedinLink: "https://www.linkedin.com/in/sreya-mit/",
  }
];
...
let exMember = document.querySelector("#ex");
...
// ***************  Ex-Core&Lead Members Details 2023 ***************************

Object.values(exMembersDetails2023).map((val) => {
  exMember.innerHTML += `
        <!-- ${val.id}.${val.name} -->
        <div class="profile_card ${val.cardBorderColor}">
            <img src="${val.avatar}" alt="Profile Img" />
